...
import Base: USE_BLAS64, abs, big, ceil, conj, convert, copy, copy!, copy_transpose!,
    ...
    imag, inv, isapprox, kron, mutablecopy, ndims, power_by_squaring, print_matrix, promote_rule, real,
...
copy_oftype{T,N}(A::AbstractArray{T,N}, ::Type{T}) = mutablecopy(A)
copy_oftype{S}(A::AbstractArray, ::Type{S}) = mutablecopy(A, S)
